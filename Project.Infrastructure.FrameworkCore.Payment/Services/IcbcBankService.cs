...
//                if (icbcInitResult != 0)
//                {
//                    throw new Exception(string.Format("错误码{0}", icbcInitResult));
//                }
//            }
//            catch (Exception ex)
//            {
//                LogHelper.GetLogger("IcbcBank").Error("招商银行通知商户验签失败,错误信息{0}。\r\n", ex.Message);
...
//            LogHelper.GetLogger("IcbcBank").Debug("工行支付请求：订单号：{0}\r\n", orderPay.OrderNo);
...
//                    }
//                }
//                LogHelper.GetLogger("IcbcBank").Debug("工商银行支付通知，{0}。\r\n", result.Message);
//                return result;
//            }
//            catch (Exception ex)
//            {
//                LogHelper.GetLogger("IcbcBank").Error("工商银行验证银行返回信息,错误异常信息{0}。\r\n", ex.Message);
//                return result;
//            }
//        }
...
//            {
//                result = false;
//                LoggerHelper.ErrorFormat("alipayLogger", "工商银行\r\n通知商户验签失败,错误码{0},详细信息{1}。\r\n", notifyDataXml);
//            }
//            return result;
//        }
...
//            builder.AppendFormat("<goodsName>{0}</goodsName>", orderPay.OrderNo);
