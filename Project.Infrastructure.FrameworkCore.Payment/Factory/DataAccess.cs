...
namespace Project.Infrastructure.FrameworkCore.Payment.Factory
{
    ...
    public class DataAccess
    {
        ...
        public static IPayService GetCreate(PayEnum payEnum)
        {
            switch (payEnum)
            {
                ...
                case PayEnum.AlipayForMobile:
                    _payCreate = new AlipayMobileService();
                    break;
        ...
        public static IPayService GetCreate(string payCode)
        {
            ...
            else if (payCode == NetPayConfig.AlipayMobileCode)
            {
                _payCreate = new AlipayMobileService();
            }
            ...
            else if (payCode == NetPayConfig.ChinaPayCode)
            {
                _payCreate = new TenpayService();
            }
            else if (payCode == NetPayConfig.CcbPayCode)
            {
                _payCreate = new CcbBankService();
            }
            else
