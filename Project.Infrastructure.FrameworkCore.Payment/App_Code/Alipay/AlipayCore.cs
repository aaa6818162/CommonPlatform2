...
namespace Project.Infrastructure.FrameworkCore.Payment.Alipay
{
    /// <summary>
    /// 类名：Core
    /// 功能：支付宝接口公用函数类
    ...
    public class Core 
    {
        ...
        {
            //var log = LogManager.GetLogger("alipayLogger");//写日志
            var msg = new StringBuilder();
            msg.Append(sWord);
            msg.Append("\r\n------------------------------------------------------------");
            //log.Info(msg.ToString());
            //LoggerHelper.Info("alipayLogger", msg);
            //string strPath = HttpContext.Current.Server.MapPath("~") + "\\AlipayLogs";
            //if (!Directory.Exists(strPath))
            //{
            //    Directory.CreateDirectory(strPath);
            //}
            //strPath = strPath + "\\" + DateTime.Now.ToString("yyyy-MM-dd HHmmss") + ".txt";
