...
namespace Project.Infrastructure.FrameworkCore.Payment.ChinaPay
{
    public static class SecurityUtil
    {
        ...
        public static byte[] Sha1X16(string dataStr, Encoding encoding)
        {
            ...
            {
                LoggerHelper.Error("sha1失败：" + e.Message);
                return null;
            }
        }
        ...
        public static byte[] SignBySoft(RSACryptoServiceProvider provider, byte[] data)
        {
            ...
            {
                LoggerHelper.Error("签名失败：" + e.Message);
                return null;
            }
        }
        ...
        private static byte[] pin2PinBlock(string aPin)
        {
            ...
            {
                LoggerHelper.Error("pin2PinBlock error" + e.Message);
            }
        ...
        private static byte[] formatPan(string aPan)
        {
            ...
            {
                LoggerHelper.Error("formatPan error:" + e.Message);
            }
            return tByte;
        }
        ...
        public static byte[] encryptedData(byte[] encData)
        {
            ...
            {
                LoggerHelper.Error("encryptedData error: " + e.Message);
                return new byte[0];
            }
        }
        ...
        public static byte[] decryptData(byte[] data, RSACryptoServiceProvider provider)
        {
            ...
            {
                LoggerHelper.Error("decryptData error: " + e.Message);
                return new byte[0];
            }
        }
