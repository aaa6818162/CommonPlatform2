...
var _menus=[
    {"menuid":"00","icon":"fa-trophy","menuname":"成功案例管理",parentMenu:'0',
        "menus": [{ "menuid": "000", "menuname": "视图", "icon": "fa-dashboard", "url":"/ProductManager/ProductCategory/List"},
            { "menuid": "001", "menuname": "仪表盘", "icon": "fa-delicious", "url":"/ProductManager/ProductCategory/List"}
            ]},{
