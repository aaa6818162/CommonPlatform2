    ...
    pro.Rule.RuleRbHdPage = {
        initPage: function () {
            ...
            if ($("#BindEntity").val()) {
                ...
                $("input[name=UseFor]").val(bindEntity.RuleSendTicketEntity.UseFor);
                ...
                $("input[name=TicketValue]").val(bindEntity.RuleSendTicketEntity.TicketValue);
