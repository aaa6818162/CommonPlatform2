            ...
            pro.PageContentCategoryControl.init({
                ...
                onLoadSuccess: function () {
                    if ($("#BindEntity").val()) {
                        ...
                        if (pro.commonKit.getUrlParam("PageContentCategoryId") > 0) {

                            $('#PageContentCategoryId').combotree('setValue', pro.commonKit.getUrlParam("PageContentCategoryId"));

                            pro.PageContent.HdPage.onChangeCategory(pro.commonKit.getUrlParam("PageContentCategoryId"));
                        }
