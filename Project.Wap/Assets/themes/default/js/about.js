...
; (function () {
    mui(".img-list").on('longtap', '.img-mask', function () {
        $(this).siblings('.del-img').show();
    });
    mui(".design-remarks").on('tap', '.J-design', function () {
        $(".design-ft").toggle();
    });
    $(".select").change(function () {
        $(this).siblings('.place-text').html($(this).val());
    })
})();
...
var nativeShare = function (elementNode, config) {
    ...
    this.init = function () {
        ...
        if (isqqBrowser || isucBrowser) {
            ...
            $(".icon-tubiaozhizuomoban15").addClass('ml20');
        }
    };
    this.init();
    var share = this;
