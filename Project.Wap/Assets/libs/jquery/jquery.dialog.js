        ...
        if ($('.' + cls).length !== 0) {
            ...
            if (type === 'alert') {
              ...
              guanbi = '<a href="javascript:;" class="onClose">' + close + '      ' + '<i>' + x + '</i></a>';
                ...
                img = '<img src="../static/img/notice.png" style="vertical-align: bottom;margin-right: 10px;">';
                txt = text;
                guanbi = '<a href="javascript:;" class="onClose">' + close + '      ' + '<i>' + x + '</i></a>';
            }
            else {
                btns = '<button class="btn s2 onsure">' + sureButton + '</button><button class="btn oncancel">' + cancelButton + '</button>';
