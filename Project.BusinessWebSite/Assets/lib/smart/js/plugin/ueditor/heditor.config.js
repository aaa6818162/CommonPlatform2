...
(function () {
  ...
  , catchRemoteImageEnable: false
    ...
    //,indentValue:'2em'
      ...
      , initialFrameWidth: 435  //初始化编辑器宽度,默认1000
      , initialFrameHeight: $(window).height() - 140  //初始化编辑器高度,默认320
    ...
    //是否可以拉伸长高,默认true(当开启时，自动长高失效)
      , scaleEnabled: false
  , imageScaleEnabled: false //图片可以拉伸
