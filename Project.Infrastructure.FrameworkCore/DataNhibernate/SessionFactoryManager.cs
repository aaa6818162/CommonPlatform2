...
using Project.Infrastructure.FrameworkCore.Sc;
...
namespace Project.Infrastructure.FrameworkCore.DataNhibernate
{
    public static class SessionFactoryManager
    {
        ...
        {
            var currentSession = CallContext.GetData("Nh_Session") as ISession;
            if (currentSession == null)
            {
                currentSession = GetNewSession();
                CallContext.SetData("Nh_Session", currentSession);
            }
            return currentSession;
        }
