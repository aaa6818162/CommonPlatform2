...
/**
 * The SchemaSortFieldException model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind")
@JsonTypeName("SchemaSortFieldException")
public class SchemaSortFieldException extends PictureparkValidationException {
    /**
     ...
     * @return the SchemaSortFieldException object itself.
     */
    public SchemaSortFieldException withSchemaId(String schemaId) {
     ...
     * @return the SchemaSortFieldException object itself.
     */
    public SchemaSortFieldException withFieldId(String fieldId) {
