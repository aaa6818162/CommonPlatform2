...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(name = "ElasticVersionUpdateException", value = ElasticVersionUpdateException.class),
    @JsonSubTypes.Type(name = "InvalidVersionException", value = InvalidVersionException.class),
    @JsonSubTypes.Type(name = "EnvironmentNotDeactivatedException", value = EnvironmentNotDeactivatedException.class),
    @JsonSubTypes.Type(name = "EnvironmentNotFoundException", value = EnvironmentNotFoundException.class),
    @JsonSubTypes.Type(name = "EnvironmentDeactivationException", value = EnvironmentDeactivationException.class),
    @JsonSubTypes.Type(name = "CustomerViolationException", value = CustomerViolationException.class),
    @JsonSubTypes.Type(name = "CustomerAliasNotFoundException", value = CustomerAliasNotFoundException.class),
    @JsonSubTypes.Type(name = "CustomerNotDeactivatedException", value = CustomerNotDeactivatedException.class),
    @JsonSubTypes.Type(name = "CustomerDeactivationException", value = CustomerDeactivationException.class),
    ...
    @JsonSubTypes.Type(name = "ConfigurationIndexNotFoundException", value = ConfigurationIndexNotFoundException.class),
    @JsonSubTypes.Type(name = "DuplicateAliasException", value = DuplicateAliasException.class),
    @JsonSubTypes.Type(name = "RedisDatabaseExceededException", value = RedisDatabaseExceededException.class)
})
