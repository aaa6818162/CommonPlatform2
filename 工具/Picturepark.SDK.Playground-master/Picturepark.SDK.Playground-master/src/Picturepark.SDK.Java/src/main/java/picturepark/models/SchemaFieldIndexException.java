...
/**
 * The SchemaFieldIndexException model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind")
@JsonTypeName("SchemaFieldIndexException")
public class SchemaFieldIndexException extends PictureparkValidationException {
    /**
     ...
     * @return the SchemaFieldIndexException object itself.
     */
    public SchemaFieldIndexException withSchemaId(String schemaId) {
     ...
     * @return the SchemaFieldIndexException object itself.
     */
    public SchemaFieldIndexException withFieldId(String fieldId) {
