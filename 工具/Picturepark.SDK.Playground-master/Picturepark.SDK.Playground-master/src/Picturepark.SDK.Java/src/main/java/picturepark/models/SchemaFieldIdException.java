...
/**
 * The SchemaFieldIdException model.
 */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "kind")
@JsonTypeName("SchemaFieldIdException")
public class SchemaFieldIdException extends PictureparkValidationException {
    /**
     ...
     * @return the SchemaFieldIdException object itself.
     */
    public SchemaFieldIdException withSchemaId(String schemaId) {
     ...
     * @return the SchemaFieldIdException object itself.
     */
    public SchemaFieldIdException withFieldId(String fieldId) {
