...
public class ContentAggregationRequest {
    ...
    /**
     * Filter the content document result set to those that have or not have
     ...
     * @return the ContentAggregationRequest object itself.
     */
    public ContentAggregationRequest withSearchBehaviours(List<String> searchBehaviours) {
     ...
     * @return the ContentAggregationRequest object itself.
     */
    public ContentAggregationRequest withBrokenDependenciesFilter(String brokenDependenciesFilter) {
