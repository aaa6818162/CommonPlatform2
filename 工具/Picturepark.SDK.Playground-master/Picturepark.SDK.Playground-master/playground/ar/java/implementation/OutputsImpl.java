...
import foobar.models.OutputDetail;
import foobar.models.OutputNotFoundException;
...
public class OutputsImpl implements Outputs {
    ...
    interface OutputsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.Outputs getByContentIds" })
        @POST("V1/Outputs")
        Observable<Response<ResponseBody>> getByContentIds(@Body ContentsByIdsRequest contentsByIdsRequest);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.Outputs get" })
