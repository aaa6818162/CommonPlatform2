...
import foobar.models.ExistsResponse;
import foobar.models.PictureparkException;
import foobar.models.SchemaCreateRequest;
import foobar.models.SchemaDetail;
import foobar.models.SchemaSearchRequest;
import foobar.models.SchemaSearchResult;
import foobar.models.SchemaUpdateRequest;
...
public class SchemasImpl implements Schemas {
    ...
    interface SchemasService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.Schemas getAll" })
        @GET("V1/Schemas")
        Observable<Response<ResponseBody>> getAll(@Query("ids") String ids);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.Schemas create" })
        @POST("V1/Schemas")
        Observable<Response<ResponseBody>> create(@Body SchemaCreateRequest schema);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.Schemas get" })
        @GET("V1/Schemas/{SchemaId}")
        Observable<Response<ResponseBody>> get(@Path("SchemaId") String schemaId);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.Schemas update" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.Schemas delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.Schemas exists" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.Schemas search" })
     ...
     */
    public ServiceFuture<Object> getAllAsync(final ServiceCallback<Object> serviceCallback) {
     ...
     */
    public Observable<Object> getAllAsync() {
        return getAllWithServiceResponseAsync().map(new Func1<ServiceResponse<Object>, Object>() {
     ...
     * @return the observable to the Object object
     */
    public Observable<ServiceResponse<Object>> getAllWithServiceResponseAsync() {
        final List<String> ids = null;
        String idsConverted = this.client.serializerAdapter().serializeList(ids, CollectionFormat.MULTI);
        return service.getAll(idsConverted)
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Object>>>() {
                
                public Observable<ServiceResponse<Object>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<Object> clientResponse = getAllDelegate(response);
     ...
     * @return the Object object if successful.
     */
    public Object getAll(List<String> ids) {
        return getAllWithServiceResponseAsync(ids).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<Object> getAllAsync(List<String> ids, final ServiceCallback<Object> serviceCallback) {
        return ServiceFuture.fromResponse(getAllWithServiceResponseAsync(ids), serviceCallback);
    }
     ...
     * @return the observable to the Object object
     */
    public Observable<Object> getAllAsync(List<String> ids) {
        return getAllWithServiceResponseAsync(ids).map(new Func1<ServiceResponse<Object>, Object>() {
     ...
     * @return the observable to the Object object
     */
    public Observable<ServiceResponse<Object>> getAllWithServiceResponseAsync(List<String> ids) {
    ...
    private ServiceResponse<Object> getAllDelegate(Response<ResponseBody> response) throws RestException, IOException {
