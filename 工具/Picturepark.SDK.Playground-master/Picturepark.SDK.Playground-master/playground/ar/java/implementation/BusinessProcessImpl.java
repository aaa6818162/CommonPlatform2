...
import foobar.models.BusinessProcessSearchResult;
 ...
 * in BusinessProcess.
 */
public class BusinessProcessImpl implements foobar.BusinessProcess {
    ...
    interface BusinessProcessService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.BusinessProcess search" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.BusinessProcess start" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.BusinessProcess markAsEnded" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.BusinessProcess sendMessage" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.BusinessProcess waitForStates" })
