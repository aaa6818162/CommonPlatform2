...
public class ListItemDetail {
     ...
     * @return the ListItemDetail object itself.
     */
    public ListItemDetail withContent(Object content) {
     ...
     * @return the ListItemDetail object itself.
     */
    public ListItemDetail withContentSchemaId(String contentSchemaId) {
     ...
     * @return the ListItemDetail object itself.
     */
    public ListItemDetail withDisplayValues(Map<String, String> displayValues) {
     ...
     * @return the ListItemDetail object itself.
     */
    public ListItemDetail withEntityType(String entityType) {
     ...
     * @return the ListItemDetail object itself.
     */
    public ListItemDetail withId(String id) {
        this.id = id;
        return this;
    }
