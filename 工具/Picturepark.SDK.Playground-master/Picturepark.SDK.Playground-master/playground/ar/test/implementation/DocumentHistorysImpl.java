...
public class DocumentHistorysImpl implements DocumentHistorys {
    ...
    interface DocumentHistorysService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.DocumentHistorys search" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.DocumentHistorys get" })
        @GET("V1/History/{Id}")
        Observable<Response<ResponseBody>> get(@Path("Id") String id);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.DocumentHistorys getVersion" })
        @GET("V1/History/{Id}/{Version}")
        Observable<Response<ResponseBody>> getVersion(@Path("Id") String id, @Path("Version") String version);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.DocumentHistorys getDifferenceLatest" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.DocumentHistorys getDifference" })
