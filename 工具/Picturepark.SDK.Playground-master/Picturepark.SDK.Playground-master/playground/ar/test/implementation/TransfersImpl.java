...
public class TransfersImpl implements Transfers {
    ...
    interface TransfersService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.Transfers deleteFiles" })
        @POST("V1/Transfers/Files/Delete")
        Observable<Response<ResponseBody>> deleteFiles(@Body FileTransferDeleteRequest request);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.Transfers getBlacklist" })
        @GET("V1/Transfers/Files/Blacklist")
        Observable<Response<ResponseBody>> getBlacklist();

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.Transfers cancelTransfer" })
        @GET("V1/Transfers/{TransferId}/Cancel")
        Observable<Response<ResponseBody>> cancelTransfer(@Path("TransferId") String transferId);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.Transfers create" })
        @POST("V1/Transfers")
        Observable<Response<ResponseBody>> create(@Body CreateTransferRequest request);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.Transfers delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.Transfers get" })
        @GET("V1/Transfers/{TransferId}")
        Observable<Response<ResponseBody>> get(@Path("TransferId") String transferId);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.Transfers getFile" })
        @GET("V1/Transfers/Files/{FileTransferId}")
        Observable<Response<ResponseBody>> getFile(@Path("FileTransferId") String fileTransferId);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.Transfers importTransfer" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.Transfers partialImport" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.Transfers search" })
        @POST("V1/Transfers/Search")
        Observable<Response<ResponseBody>> search(@Body TransferSearchRequest request);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.Transfers searchFiles" })
