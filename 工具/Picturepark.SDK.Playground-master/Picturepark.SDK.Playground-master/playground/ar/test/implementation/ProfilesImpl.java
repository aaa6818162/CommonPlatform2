...
public class ProfilesImpl implements Profiles {
    ...
    interface ProfilesService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.Profiles get" })
        @GET("V1/Profile")
        Observable<Response<ResponseBody>> get();

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.Profiles update" })
        @PUT("V1/Profile")
