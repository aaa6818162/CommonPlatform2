...
public class PublicAccessImpl implements PublicAccess {
    ...
    interface PublicAccessService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.PublicAccess getVersion" })
        @GET("V1/PublicAccess/Version")
        Observable<Response<ResponseBody>> getVersion();

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.PublicAccess getShare" })
