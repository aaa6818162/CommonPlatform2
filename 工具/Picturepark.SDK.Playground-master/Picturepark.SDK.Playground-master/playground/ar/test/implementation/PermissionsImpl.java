...
public class PermissionsImpl implements Permissions {
    ...
    interface PermissionsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.Permissions getUserPermissions" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.Permissions searchContentPermissions" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.Permissions getContentPermissions" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.Permissions searchSchemaPermissions" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: picturepark.Permissions getSchemaPermissions" })
