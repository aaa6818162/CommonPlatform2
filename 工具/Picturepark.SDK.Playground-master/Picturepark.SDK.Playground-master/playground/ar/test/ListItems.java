...
public interface ListItems {
     ...
     */
    PictureparkException delete(String objectId, int timeout);
     ...
     * @return the {@link ServiceFuture} object
     */
    ServiceFuture<PictureparkException> deleteAsync(String objectId, int timeout, final ServiceCallback<PictureparkException> serviceCallback);
     ...
     */
    Observable<PictureparkException> deleteAsync(String objectId, int timeout);
     ...
     * @return the observable to the PictureparkException object
     */
    Observable<ServiceResponse<PictureparkException>> deleteWithServiceResponseAsync(String objectId, int timeout);
