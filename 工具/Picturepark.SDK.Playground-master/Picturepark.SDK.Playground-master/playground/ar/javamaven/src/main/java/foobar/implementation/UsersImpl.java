...
import foobar.models.Channel;
import foobar.models.PictureparkException;
import foobar.models.UserDetail;
import foobar.models.UserSearchRequest;
import foobar.models.UserSearchResult;
...
public class UsersImpl implements Users {
    ...
    interface UsersService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.Users search" })
        @POST("V1/Users/Search")
        Observable<Response<ResponseBody>> search(@Body UserSearchRequest searchRequest);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.Users getUser" })
        @GET("V1/Users/GetUser/{UserId}")
        Observable<Response<ResponseBody>> getUser(@Path("UserId") String userId);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.Users getByOwnerToken" })
        @GET("V1/Users/Owner/{TokenId}")
        Observable<Response<ResponseBody>> getByOwnerToken(@Path("TokenId") String tokenId);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.Users getChannels" })
