...
import foobar.models.BusinessProcess;
import foobar.models.BusinessProcessWaitResult;
import foobar.models.ListItemAggregationRequest;
import foobar.models.ListItemCreateRequest;
import foobar.models.ListItemDetail;
...
import foobar.models.ListItemSearchResult;
...
public class ListItemsImpl implements ListItems {
    ...
    interface ListItemsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.ListItems create" })
        @POST("V1/ListItems")
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.ListItems createMany" })
        @POST("V1/ListItems/Many")
        Observable<Response<ResponseBody>> createMany(@Body List<ListItemCreateRequest> objects);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.ListItems deleteMany" })
        @HTTP(path = "V1/ListItems/Many", method = "DELETE", hasBody = true)
        Observable<Response<ResponseBody>> deleteMany(@Query("ids") String ids);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.ListItems updateMany" })
        @PUT("V1/ListItems/Many")
        Observable<Response<ResponseBody>> updateMany(@Body List<ListItemUpdateRequest> objects);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.ListItems aggregate" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.ListItems search" })
        @POST("V1/ListItems/Search")
        Observable<Response<ResponseBody>> search(@Body ListItemSearchRequest listItemSearchRequest);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.ListItems get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.ListItems update" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.ListItems updateFieldsByFilter" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.ListItems updateFields" })
        @PUT("V1/ListItems/Many/Fields")
        Observable<Response<ResponseBody>> updateFields(@Body ListItemFieldsUpdateRequest updateRequest);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.ListItems waitForStates" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: foobar.ListItems importMethod" })
        @GET("V1/ListItems/Import")
        Observable<Response<ResponseBody>> importMethod(@Query("contentId") String contentId, @Query("fileTransferId") String fileTransferId, @Query("includeObjects") boolean includeObjects);
     ...
     */
    public PictureparkException importMethod(String contentId, String fileTransferId, boolean includeObjects) {
        return importMethodWithServiceResponseAsync(contentId, fileTransferId, includeObjects).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<PictureparkException> importMethodAsync(String contentId, String fileTransferId, boolean includeObjects, final ServiceCallback<PictureparkException> serviceCallback) {
        return ServiceFuture.fromResponse(importMethodWithServiceResponseAsync(contentId, fileTransferId, includeObjects), serviceCallback);
    }
     ...
     */
    public Observable<PictureparkException> importMethodAsync(String contentId, String fileTransferId, boolean includeObjects) {
        return importMethodWithServiceResponseAsync(contentId, fileTransferId, includeObjects).map(new Func1<ServiceResponse<PictureparkException>, PictureparkException>() {
     ...
     * @return the observable to the PictureparkException object
     */
    public Observable<ServiceResponse<PictureparkException>> importMethodWithServiceResponseAsync(String contentId, String fileTransferId, boolean includeObjects) {
        if (contentId == null) {
        ...
        return service.importMethod(contentId, fileTransferId, includeObjects)
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<PictureparkException>>>() {
                ...
                public Observable<ServiceResponse<PictureparkException>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<PictureparkException> clientResponse = importMethodDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<PictureparkException> importMethodDelegate(Response<ResponseBody> response) throws RestException, IOException, IllegalArgumentException {
