...
namespace Project.Model.OrderManager
{
    public class OrderMainEntity : Entity
    {
        ...
        /// 会员折扣
        /// </summary>
        public virtual System.Int32 CustomerDiscount { get; set; }
        ...
        /// 可参与的活动Id
        /// </summary>
        public virtual System.String ActivityIds { get; set; }

        /// <summary>
        /// 券
        /// </summary>
        public virtual  System.String UseTicketCodes { get; set; }
        #endregion
        ...
        public virtual DateTime? Whe_CreateDateStart { get; set; }

        public virtual DateTime? Whe_CreateDateEnd { get; set; }
